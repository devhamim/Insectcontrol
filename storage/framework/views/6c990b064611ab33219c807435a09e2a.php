                                    ...
                                    <tr id="tr_<?php echo e($order->id); ?>">
                                        ...
                                        <td>
                                            <?php if($order->landing == 1): ?>
                                                <img width="100" src="<?php echo e(asset('frontend/assets/land_img.jpg')); ?>" alt="Image" />
                                            <?php else: ?>
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\all project\insectcontrol\resources\views/backend/order/listorder.blade.php ENDPATH**/ ?>
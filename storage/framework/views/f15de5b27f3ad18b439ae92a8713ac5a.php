                    ...
                    <div class="row mt-5">
                        ...
                        <div class="col-lg-6 text-white text-end">
                            <div class="video_right">
                                <img src="<?php echo e(asset('landingpage/images/product/i-1.jpg')); ?>" alt="">
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-ls-12">
                    <div class="autoplay">
                        ...
                        <div class="px-3">
                            <img src="<?php echo e(asset('landingpage/images/product/i-2.jpg')); ?>" alt="">
                        </div>
                        <div class="px-3">
                            <img src="<?php echo e(asset('landingpage/images/product/i-3.jpg')); ?>" alt="">
                        </div>
                        <div class="px-3">
                            <img src="<?php echo e(asset('landingpage/images/product/i-4.jpg')); ?>" alt="">
                        </div>
                    </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-ls-12">
                    <div class="autoplay">
                        <div class="px-3">
                            <img src="<?php echo e(asset('landingpage/images/product/i-11.jpg')); ?>" alt="">
                        </div>
                        <div class="px-3">
                            <img src="<?php echo e(asset('landingpage/images/product/i-22.jpg')); ?>" alt="">
                        </div>
                        <div class="px-3">
                            <img src="<?php echo e(asset('landingpage/images/product/i-33.jpg')); ?>" alt="">
                        </div>
                        <div class="px-3">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        ...
                                        <div class="product_box">
                                            <input type="radio" id="product_1" name="radio_btn" value="1" data-product-name="বেড বাগ কিলার ২৫০ মিলি"  data-price="350" data-image="<?php echo e(asset('landingpage/images/product/i-1.jpg')); ?>" checked="checked">
                                            <img src="<?php echo e(asset('landingpage/images/product/i-1.jpg')); ?>" alt="" width="80" height="80">
                                    ...
                                    <div class="col-lg-6">
                                        <!-- Product Row 2 -->
                                        <div class="product_box">
                                            <input type="radio" name="radio_btn" id="product_2" value="2" data-product-name="বেড বাগ কিলার ৫০০ মিলি"  data-price="590" data-image="<?php echo e(asset('landingpage/images/product/i-2.jpg')); ?>">
...
<?php /**PATH F:\all project\insectcontrol\resources\views/landingpage/forepage.blade.php ENDPATH**/ ?>